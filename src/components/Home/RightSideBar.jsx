    ...
    return (
        <div className=' space-y-2'>
            ...
            <div className='flex flex-col gap-3'>
                <button className='btn border-[#7dadf7] text-[#7dadf7]'><FaGoogle />Login With Google</button>
                <button className='btn border-[#3e4344] text-[#3e4344]'><FaGithub />Login With Github</button>
            </div>
            <div className=' space-y-2'>
